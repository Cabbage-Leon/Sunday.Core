...
namespace Sunday.Core.Project.Persistence.Seed
{
    public class FrameSeed
    {
        ...
        {
            Create_Model_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Blog.Core.Model", "Sunday.Core.Domain.Entities", tableNames, "", isMuti);
            return true;
        }
