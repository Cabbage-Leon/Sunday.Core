...
namespace Sunday.Core.Extensions.Apollo
{
    public static class ConfigurationBuilderExtensions
    {
        ...
        //获取数据格式对应的枚举
        private static IEnumerable<string> GetConfigFileFormat() => ((ConfigFileFormat[])Enum.GetValues(typeof(ConfigFileFormat))).Select(u => u.ToString().ToLower());
